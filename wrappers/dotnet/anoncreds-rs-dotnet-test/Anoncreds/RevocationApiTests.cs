...
namespace anoncreds_rs_dotnet_test.Anoncreds
{
    public class RevocationApiTests
    {
        ...
        public async Task UpdateRevocationStatusListAsyncWorks()
        {
            ...
            _ = mockRevRegStatList.RevocationList[0].Should().Be(0);
            _ = mockRevRegStatList.RevocationList[1].Should().Be(0);
            ...
            //Assert
            _ = actual2.RevocationList[0].Should().Be(1);
            _ = actual2.RevocationList[1].Should().Be(0);
            _ = actual2.RevocationList[2].Should().Be(1);
