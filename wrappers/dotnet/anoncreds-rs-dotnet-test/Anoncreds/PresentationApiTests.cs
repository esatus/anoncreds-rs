    ...
    public class PresentationApiTests
    {
        ...
        public async Task CreatePresentationAsyncOfSelfAttestProofThrows()
        {
            ...
            (RevocationRegistryDefinition revRegDefObject, RevocationRegistryDefinitionPrivate revRegDefPvtObject) = await RevocationApi.CreateRevocationRegistryDefinitionAsync(
                mockCredDef.IssuerId, mockCredDef, "mock:credDefId",
                "test_tag",
                RegistryType.CL_ACCUM,
                99,
                testTailsPathForRevocation);
            ...
            Credential credObject = await CredentialApi.CreateCredentialAsync
                (mockCredDef, mockCredDefPrivate, mockCredOffer, credRequestObject, attrNames, attrNamesRaw, attrNamesEnc, revStatusList, null, revRegDefObject, revRegDefPvtObject, 1);
            ...
            Func<Task<Presentation>> func = async () => await PresentationApi.CreatePresentationAsync(
                new PresentationRequest { Handle = new IntPtr() },
                credentialEntries,
                credentialProofs,
                selfAttestNames,
                selfAttestValues,
        ...
        public async Task CreatePresentationJsonAsyncOfSelfAttestProofThrows()
        {
            ...
            List<string> credentialDefinitions = new() { mockCredDef.JsonString };

            List<string> selfAttestNames = new() { presReqObject.RequestedAttributes.First().Key };

            List<string> selfAttestValues = new() { "testSomeValue" };
        ...
        //{
        //    //Arrange
        //    string presentationJson = "{\"proof\":{\"proofs\":[{\"primary_proof\":{\"eq_proof\":{\"revealed_attrs\":
        //    {\"attr\":\"72155939486846849509759369733266486982821795810448245423168957390607644363272\"},
        //    \"a_prime\":\"
        //    8178657965616831942802640713754838111099765928053264003133303245178307245238269379969657844386541201731429479010183162613731023271140443137949920801708151362109823177071910561747744940225633896803721317669782358421\",
        ...
        //    \"v\":\"
        //    \",
        ...
        //    \"r\":\"0D0387C22AA96E9D00AC180BF461BA40809BE312BB0FC57B392B4660F8AC02C9\",\"r_prime\":\"156475DD528D2A7F6A7711479C40A634F76A82A0AD098DEFC957CF500ADDD6F6\",
        //    \"r_prime_prime\":\"1262D4B6EE055CB7B12AC9CCC5A8C5551DC1398D925162FD63B19A7E27E47601\",\"r_prime_prime_prime\":\"1FC79BA981C70CF3FDDBEE8F3908C63F195284DA250B9F4BF0B8C444F00A1DA5\",
        //    \"o\":\"0645F0F20692FC3EB7A8AC6DF8975475D69046A3A1AA2F9454309976628CC2D6\",\"o_prime\":\"0E17AE4D4A318BE3F22B8741A9CD401EEF8EDF2571234353DE93C71F91AEB868\",
        ...
        //    \"t\":\"10ACE2A8623DCB973DF484C9634FB4DC94BA9097F89ABA3C5863693F9EC5F223\",\"t_prime\":\"236B85805AD43E4EEA0DE3A03A764BF717805EC5AADEEAD2566B485B7CAC81D1\",
        //    \"m2\":\"1BA5E259DB355BC7D8A7DB2B76E6CA77F6BF7EFA08D19E7F533836005F6FBAB3\",\"s\":\"0B1339A60E431657FFDACA6D5C79CC964471B7595B4D34562AAD8E4648E78A82\",
        //    \"c\":\"16608A5E3549E73F2F6A32D54D8AE8B0B2DF36DDE1410876BFE20287CB069E63\"},
        //    \"requested_proof\":{\"revealed_attrs\":{\"reft\":{\"sub_proof_index\":0,\"raw\":\"test\",\"encoded\":\"72155939486846849509759369733266486982821795810448245423168957390607644363272\"}},\"self_attested_attrs\":{},\"unrevealed_attrs\":{},\"predicates\":{}},
        //    \"identifiers\":[{\"schema_id\":\"55GkHamhTU1ZbTbV2ab9DE:2:schema name:schema version\",\"cred_def_id\":\"55GkHamhTU1ZbTbV2ab9DE:3:CL:15:tag\",\"rev_reg_id\":\"55GkHamhTU1ZbTbV2ab9DE:4:55GkHamhTU1ZbTbV2ab9DE:3:CL:15:tag:CL_ACCUM:default\",\"timestamp\":1656323735}]}";
        ...
        //[Test, TestCase(TestName = "CreatePresentationFromJsonAsync() throws AnoncredsRsException when given empty string.")]
        ...
        [Test, TestCase(TestName = "VerifyPresentationAsync() works with revocation and requestedAttribute.")]
        public async Task VerifyPresentationWorksRevocRequestedAttribute()
        {
            //Arrange
            int index = 0;
            string testTailsPathForRevocation = null;
            string issuerUri = "issuer:esatusAG";
            string mockSchemaId = "mock:schemaId";
            string mockCredDefId = "mock:credDefId";
            string mockEntropy = "mockEntropy";
            string mockLinkSecretName = "mockLinkSecretName";
            string mockRevRegDefIssuerUri = "mock:RevRegDefIssuerUri";
            long timestamp = 100;//DateTimeOffset.Now.ToUnixTimeSeconds();
            string mockLinkSecret = await LinkSecretApi.CreateLinkSecretAsync();

            Schema mockSchema = await MockDataProvider.MockSchema(issuerUri: issuerUri);
            (List<string> attributeNames, List<string> attributeValues, List<string> attributeEnc) = await MockDataProvider.MockAttrValues(mockSchema);

            (CredentialDefinition mockCredDef, CredentialDefinitionPrivate mockCredDefPrivate, CredentialKeyCorrectnessProof mockCredKeyCorrProof) = await CredentialDefinitionApi.CreateCredentialDefinitionAsync(
                mockSchemaId,
                mockSchema,
                "mockCredDefTag",
                issuerUri,
            ...
            Credential credential = await MockDataProvider.MockCredential(
                credentialDefinition: mockCredDef,
                credentialDefinitionPrivate: mockCredDefPrivate,
                credentialOffer: mockCredOffer,
                credentialRequest: mockCredRequest,
                attributeNames: attributeNames,
                valuesRaw: attributeValues,
                valuesEncoded: attributeEnc,
                revocationStatusList: revStatusListObject,
                revocationRegistryId: mockRevRegDefIssuerUri,
            ...
            //Process Credential does not work with parameter revRegDefObject 
            //Credential credentialProcessed = await CredentialApi.ProcessCredentialAsync(credential, mockCredReqMetadata, mockLinkSecret, mockCredDef, revRegDefObject);
            Credential credentialProcessed = credential;
            //

            string revStateJson = await RevocationApi.CreateOrUpdateRevocationStateAsync(
                        revRegDefJson: revRegDefObject.JsonString,
                        newRevStatusListJson: revStatusListObject.JsonString,
                        revRegIndex: index,
                        tailsPath: JObject.Parse(revRegDefObject.JsonString)["value"]["tailsLocation"].ToObject<string>(),
                        revStateJson: null,
